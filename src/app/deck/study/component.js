    ...
    return html`
      <m-stack align="center">
        ...
        <m-stack direction="column" spacing="none">
          ...
          <m-text size="xxxs">Há <strong>${self.pendingCards}</strong> revisões aguardando você.</m-text>
        </m-stack>
      </m-stack>
    ...
    return html`
      <m-stack align="center">
        ...
        <m-stack direction="column" spacing="none">
          ...
          <m-text size="xxxs">Volte em <strong>${self.nextReviewIn}</strong> para continuar seu aprendizado.</m-text>
        </m-stack>
      </m-stack>
    `;
  }
