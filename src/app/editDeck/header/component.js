...
function component(self) {
  return html`
    <m-header>
      <m-button slot="leading" id="backToDeck" variant="link">
      ...
      <m-show when="${self.deck.paused}" slot="trailing">
        <m-stack align="center">
          ...
          <m-button id="play" color="danger" variant="link">
            <m-icon use="play"></m-icon>
          </m-button>
        </m-stack>
      </m-show>
      <m-hide when="${self.deck.paused}" slot="trailing">
        <m-button id="pause" color="danger" variant="link">
          <m-icon use="pause"></m-icon>
        </m-button>
      </m-hide>
      <m-button slot="trailing" id="delete" color="danger" variant="link">
