    ...
    <stack.Main className={style.privacyPolicy__main} column>
      ...
      <stack.Article column>
        ...
        <text.P master xxs justify>
         This Privacy Policy outlines how Memoize Corp. ("we," "our," or "us") collects, uses, and safeguards your personal information when you use the Memoize application (the "App"). We are committed to protecting your privacy and ensuring the security of your personal data. By using the App, you consent to the practices described in this Privacy Policy.
        </text.P>
        <text.H2 master dark highlight sm bold justify>Information We Collect:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>How We Use Your Information:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Data Security:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Third-Party Services:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Data Retention:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Your Rights:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Children's Privacy:</text.H2>
        <text.P master xxs justify>
        ...
        <text.H2 master dark highlight sm bold justify>Changes to Privacy Policy:</text.H2>
        <text.P master xxs justify>
