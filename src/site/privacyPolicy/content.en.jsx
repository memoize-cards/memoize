...
function component () {
  return (
    <div className={style.content}>
      ...
      <text.H2 master dark highlight xxs bold>Information We Collect</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>How We Use Your Information</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Data Security</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Third-Party Services</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Data Retention</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Your Rights</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Children's Privacy</text.H2>
      <text.P master xxxs>
      ...
      <text.H2 master dark highlight xxs bold>Changes to Privacy Policy</text.H2>
      <text.P master xxxs>
      ...
      <text.P master xxxs>
        If you have any questions about this Privacy Policy, please contact us at <text.A href='mailtocleber.engineer@gmail.com' primary xxxs medium>cleger.engineer@gmail.com</text.A>.
      </text.P>
      <text.P master xxxs>
